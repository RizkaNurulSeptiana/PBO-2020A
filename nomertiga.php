...
//NIM   : 20051397025//
//Prodi : 2020A - D4 Manajemen Informatika//

<?php

echo "<h2>"."3. PROGRAM DATA NOVEL DETEKTIF" . "</h2>". "<br>" ;
...
class novelDetektif {
    ...
    public function getHargaJual(){
        return $this->hargaBeli-20/100*$this->hargaBeli;
    }
...
// $hargaBeli1 = new hitung();
// $hargaBeli1->harga=70000;


// echo $hargaJual = $hargaBeli1-2/100*$hargaBeli1;
